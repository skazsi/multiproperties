...
public class SchemaConverter implements ISchemaConverter
{
    ...
    private static final String SCHEMA_PACKAGE = "hu.skzs.multiproperties.base.model.fileformat_1_0";
    ...
    public Table convert(IFile file) throws SchemaConverterException
    {
        ...
        {
            throw new SchemaConverterException("Unexpected error in schema conversion", e);
        }
    }
