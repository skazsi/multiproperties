package hu.skzs.multiproperties.base.model.fileformat_1_2;
...
/**
 * The <code>SchemaConverter</code> is an implementation of {@link ISchemaConverter} for <code>1.2</code> format.
 * 
 * @author skzs
 */
public class SchemaConverter implements ISchemaConverter
{
	...
	private static final String SCHEMA_PACKAGE = "hu.skzs.multiproperties.base.model.fileformat_1_2"; //$NON-NLS-1$
		...
		try
		{
			...
			for (int i = 0; i < table.size(); i++)
			{
				if (table.get(i) instanceof PropertyRecord)
				{
					...
					property.setMultiLine(propertyRecord.isMultiLine());
